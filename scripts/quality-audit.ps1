...
Add-Score $rows "reliability" "required files" 4 ($missing.Count -eq 0) "$(14 - $missing.Count)/14 files"
...
Add-Score $rows "deployment" "security headers" 3 ($hasFrameHeader -and $hasContentTypeHeader) "headers"
...
Add-Score $rows "growth" "free roadmap" 3 $hasRoadmap "roadmap"
Add-Score $rows "growth" "premium candidates" 3 $roadmapSize "future paid roadmap"
